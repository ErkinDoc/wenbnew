      ...
      <div className="section-container relative z-10">
        <div className="section-inner min-h-[calc(100vh-96px)] flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full py-12 lg:py-0">
            ...
            {/* Right column - Professional Portrait Placeholder */}
            <motion.div 
            ...
            >
              <div className="relative">
                ...
                <div className="relative w-[300px] h-[400px] sm:w-[360px] sm:h-[480px] lg:w-[420px] lg:h-[560px] 
                                bg-gradient-to-br from-[#E6F0EA] to-[#F7F9FC] rounded-xl 
                                flex flex-col items-center justify-center border border-[#E2E8F0]">
                  <div className="w-32 h-32 bg-[#1A365D]/10 rounded-full flex items-center justify-center mb-6">
                    <Shield className="w-16 h-16 text-[#1A365D]/40" />
                  </div>
                  <p className="text-[14px] text-[#4A5568] text-center font-sans max-w-[200px]">
                    Professional Clinical Portrait
                  </p>
                  <p className="text-[12px] text-[#718096] text-center font-sans mt-2">
                    Premium medical attire<br/>Approachable yet authoritative
                  </p>
                  
                  {/* Credentials floating badge */}
                  <div className="absolute bottom-6 left-6 right-6 bg-white rounded-lg shadow-lg p-4 border border-[#E2E8F0]">
